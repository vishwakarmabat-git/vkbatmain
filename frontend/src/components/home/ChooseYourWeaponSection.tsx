          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 max-w-4xl mx-auto">
            ...
            <div className="relative w-full sm:max-w-md">
              ...
              <input
                ...
                className="w-full bg-[#0E0E12] border border-[#1E1E28] focus:border-[#D4AF37] text-white pl-10 pr-4 py-2.5 rounded-lg text-xs focus:outline-none placeholder:text-[#52525B]"
              />
            </div>
            ...
            <div className="relative shrink-0">
              <select
                ...
                className="bg-[#0E0E12] border border-[#1E1E28] focus:border-[#D4AF37] text-white px-4 py-2.5 pr-8 rounded-lg text-xs font-sport tracking-wider uppercase focus:outline-none appearance-none cursor-pointer"
              >
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 pt-2">
            {categoryPills.map((pill) => (
              <button
                ...
                className={`font-sport font-black px-4 py-2 rounded-xs text-xs tracking-wider uppercase transition-all duration-200 cursor-pointer ${
