    ...
    <section className="w-full py-16 bg-[#09090B] text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center space-y-3 max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-serif font-black tracking-tight text-white uppercase leading-tight">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-full bg-[#181820] border border-[#2A2A36] focus:border-[#D4AF37] text-white p-3 rounded-xs text-xs focus:outline-none cursor-pointer"
                    >
                      <option value="Light (1110 - 1140g)">Light (1110 - 1140g)</option>
                      <option value="Medium (1150 - 1180g)">Medium (1150 - 1180g)</option>
                      <option value="Heavy (1190 - 1220g)">Heavy (1190 - 1220g)</option>
                      <option value="Monster Edge (1230g+)">Monster Edge (1230g+)</option>
                    </select>
                  </div>
                </div>
