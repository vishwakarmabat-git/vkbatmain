...
export const CraftsmanshipTimelineSection: React.FC = () => {
  ...
  return (
    <section className="w-full py-20 bg-[#09090B] text-center relative overflow-hidden">
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 pl-10 md:pl-0 md:px-8 text-left">
                    <div className="bg-[#12121A] border border-[#242436] hover:border-[#D4AF37]/60 rounded-xl p-6 sm:p-7 transition-all duration-300 hover:shadow-[0_0_25px_rgba(212,175,55,0.12)] space-y-2 group">
                      <span className="font-serif font-black text-2xl text-[#D4AF37] block">
                        {step.number}
                      </span>
